...
| **HTML** | Self-contained static dashboard with color-coded bars for bounded metrics, no server required |
...
# Disable colors via NO_COLOR environment variable (https://no-color.org/)
NO_COLOR=1 codepulse ./my-project
